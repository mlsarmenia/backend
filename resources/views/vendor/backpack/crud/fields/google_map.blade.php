...
@push('crud_fields_scripts')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3&key={{config('services.google_places.key') }}&libraries=places&callback=initGoogleAddressAutocomplete&language={{$field['map_options']['language']}}" async defer></script>
