...
class ContactRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'client.*.price_from' => ['nullable', 'integer', 'min:0'],
            'client.*.price_to' => ['nullable', 'integer', 'min:0'],
            'client.*.area_from' => ['nullable', 'integer', 'min:0'],
            'client.*.area_to' => ['nullable', 'integer', 'min:0'],
