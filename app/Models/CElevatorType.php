 ...
 * @package App\Models
 */
class CElevatorType extends Model
{
    use CrudTrait;
	protected $table = 'c_elevator_type';
	...
	{
		return $this->hasMany(Announcement::class, 'elevator_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'elevator_type_id');
	}
}
