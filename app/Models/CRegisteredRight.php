 ...
 * @package App\Models
 */
class CRegisteredRight extends Model
{
    use CrudTrait;
	protected $table = 'c_registered_right';
	...
	{
		return $this->hasMany(Announcement::class, 'registered_right_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'registered_right_id');
	}
}
