 ...
 * @package App\Models
 */
class CLandStructureType extends Model
{
    use CrudTrait;
	protected $table = 'c_land_structure_type';
	...
	{
		return $this->hasMany(Announcement::class, 'land_structure_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'land_structure_type_id');
	}
}
