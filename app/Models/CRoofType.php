 ...
 * @package App\Models
 */
class CRoofType extends Model
{
    use CrudTrait;
	protected $table = 'c_roof_type';
	...
	{
		return $this->hasMany(Announcement::class, 'roof_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'roof_type_id');
	}
}
