 ...
 * @package App\Models
 */
class CServiceFeeType extends Model
{
    use CrudTrait;
	protected $table = 'c_service_fee_type';
	...
	{
		return $this->hasMany(Announcement::class, 'service_fee_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'service_fee_type_id');
	}
}
