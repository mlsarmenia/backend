 ...
 * @package App\Models
 */
class CFrontWithStreet extends Model
{
    use CrudTrait;
	protected $table = 'c_front_with_street';
	...
	{
		return $this->hasMany(Announcement::class, 'front_with_street_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'front_with_street_id');
	}
}
