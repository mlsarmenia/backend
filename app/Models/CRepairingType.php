 ...
 * @package App\Models
 */
class CRepairingType extends Model
{
    use CrudTrait;
	protected $table = 'c_repairing_type';
	...
	{
		return $this->hasMany(Announcement::class, 'repairing_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'repairing_type_id');
	}
}
