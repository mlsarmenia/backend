 ...
 * @package App\Models
 */
class CExteriorDesignType extends Model
{
    use CrudTrait;
	protected $table = 'c_exterior_design_type';
	...
	{
		return $this->hasMany(Announcement::class, 'exterior_design_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'exterior_design_type_id');
	}
}
