 ...
 * @package App\Models
 */
class CParkingType extends Model
{
    use CrudTrait;
	protected $table = 'c_parking_type';
	...
	{
		return $this->hasMany(Announcement::class, 'parking_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'parking_type_id');
	}
}
