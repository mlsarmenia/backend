 ...
 * @package App\Models
 */
class CHouseBuildingType extends Model
{
    use CrudTrait;
	protected $table = 'c_house_building_type';
	...
	{
		return $this->hasMany(Announcement::class, 'house_building_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'house_building_type_id');
	}
}
