 ...
 * @package App\Models
 */
class CRoadWayType extends Model
{
    use CrudTrait;
	protected $table = 'c_road_way_type';
	...
	{
		return $this->hasMany(Announcement::class, 'road_way_type_id');
	}

	public function estates()
	{
		return $this->hasMany(Estate::class, 'road_way_type_id');
	}
}
